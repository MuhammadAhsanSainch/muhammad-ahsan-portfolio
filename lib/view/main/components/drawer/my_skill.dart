...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.82, title: 'Flutter',image: 'assets/icons/flutter.png',),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.72, title: 'Bloc',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 0.73, title: 'Getx',image: 'assets/icons/dart.png'),
      ],);
  }
}
